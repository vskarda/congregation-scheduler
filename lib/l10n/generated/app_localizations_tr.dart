...
class AppLocalizationsTr extends AppLocalizations {
  ...
  @override
  String get navHelp => 'Yardım';

  @override
  String get helpPublisherSection => 'Müjdeciler için ipuçları';

  @override
  String get helpAdminSection => 'Yöneticiler için';

  @override
  String get helpCalendarTitle => 'Takvime ekleme';

  @override
  String get helpCalendarBody =>
      'Mobil uygulamada etkinliklerin ve görevlerinizin yanında takvim simgesi görünür. Üzerine dokunarak öğeyi cihazınızın takvimine ekleyebilirsiniz.';

  @override
  String get helpRemindersTitle => 'Görev hatırlatıcıları';

  @override
  String get helpRemindersBody =>
      'Etkinlikler ekranında \"Yaklaşan Görevlerim\" bölümünün yanındaki zil simgesine dokunun ve her görevden ne kadar önce bildirim almak istediğinizi seçin. (Yalnızca mobil uygulamada.)';

  @override
  String get helpHighlightTitle => 'Kendinizi bir bakışta bulun';

  @override
  String get helpHighlightBody =>
      'İbadet programlarında kendi adınız vurgulanır, böylece görevlerinizi hemen görebilirsiniz.';

  @override
  String get helpTerritoryMapTitle => 'Saha haritasını açma';

  @override
  String get helpTerritoryMapBody =>
      'Bir sahanın yanındaki harita simgesine dokunarak haritasını açabilirsiniz. Gri simge, o saha için henüz harita bağlantısı eklenmediği anlamına gelir.';

  @override
  String get helpAdminToggleTitle => 'Uygulamayı müjdeci olarak görüntüleme';

  @override
  String get helpAdminToggleBody =>
      'Üst çubuktaki kalem simgesi tüm yönetici araçlarını geçici olarak gizler; böylece uygulamayı müjdecilerin gördüğü şekilde görürsünüz. Tekrar dokununca araçlar geri gelir.';

  @override
  String get helpPdfExportTitle => 'Programları yazdırma ve paylaşma';
  ...
  String get helpGoogleMyMapsBody =>
      'Saha haritalarınızı Google My Maps\'te oluşturun ve her sahanın paylaşım bağlantısını harita bağlantısı alanına yapıştırın. Adım adım rehber GitHub\'da mevcuttur.';

  @override
  String get helpOpenGuide => 'Rehberi aç';

  @override
  String get helpDataDelayTitle => 'Değişikliklerin görünmesi biraz sürebilir';

  @override
  String get helpDataDelayBody =>
      'Uygulamada yapılan değişiklikler — örneğin Müjdeciler\'deki düzenlemeler — görünür olması bir dakika kadar sürebilir. (Örneğin bazen S-21 içe aktarımı, mevcut hizmet yılının hizmet saatlerini hemen göstermez.)';

  @override
  String get helpPwApplyTitle => 'Halka açık şahitliğe başvurma';
  ...
  String get helpPwAssignBody =>
      'Her gönüllünün \"Halka açık yerde şahitlik\" niteliğini Müjdeciler → bir müjdeciyi aç → Nitelikler bölümünden açın. Ardından Halka Açık Şahitlik\'te bir zaman aralığını açıp \"Atanan\" öğesine dokunun: başvuran müjdeciler listenin en üstünde \"Başvurdu\" rozetiyle görünür. Haftalık standlar için tekrarlanan zaman aralıklarını kullanın.';

  @override
  String get helpS21Title => 'S-21 kayıtlarını içe aktarma';

  @override
  String get helpS21Body =>
      'Bir müjdecinin Cemaat Müjdeci Kaydı\'nı (S-21) bir PDF\'den içe aktarabilirsiniz. Müjdeciler → bir müjdeci → S-21\'i açın ve dosyayı seçin. Yalnızca PDF\'nin metin katmanı okunur; bu yüzden taranmış veya düzleştirilmiş formlar içe aktarılamayabilir.';

  @override
  String get helpS99Title =>
      'Halka yönelik konuşma başlıklarını içe aktarma (S-99)';

  @override
  String get helpS99Body =>
      'Halka Yönelik Konuşma Başlıkları\'nda \"Başlıkları PDF\'den Güncelle\" seçeneğini seçin ve resmî bir S-99 formu PDF\'i seçin. Bu konuşma numaralarına atıfta bulunan yaklaşan hafta sonu ibadetleri otomatik olarak güncellenir.';
  ...
  String get fsmRecurringDeleteConfirm =>
      'Bu tekrarlanan buluşma silinsin mi? Gelecekteki buluşmaları da kaldırılacak. Bu işlem geri alınamaz.';

  @override
  String get fsmRemoveAllFutureAction => 'Tüm gelecekteki buluşmaları kaldır';

  @override
  String get fsmRemoveAllFutureWarning =>
      'Tüm gelecekteki buluşmaları kaldırmak, yaklaşan her tek seferlik ve tekrarlanan buluşmayı siler ve bu işlem geri alınamaz.';

  @override
  String get fsmRemoveAllFutureTitle =>
      'Tüm gelecekteki buluşmalar kaldırılsın mı?';

  @override
  String get fsmRemoveAllFutureBody =>
      'Bu işlem yaklaşan tüm tek seferlik ve tekrarlanan tarla buluşmalarını siler ve yeniden oluşmamaları için tüm tekrarlanan buluşma kurallarını kaldırır. Geçmiş buluşmalar saklanır. Bu işlem geri alınamaz.';
  ...
  @override
  String get remindersTitle => 'Görev hatırlatıcıları';

  @override
  String get remindersDescription =>
      'Yaklaşan her görevinizden önce bu cihazda bildirim alın. Uygulama kapalıyken yapılan değişiklikler, uygulamayı bir sonraki açışınızda alınır.';

  @override
  String get remindersEnable => 'Hatırlatıcıları etkinleştir';

  @override
  String get remindersAdd => 'Hatırlatıcı ekle';

  @override
  String get reminderUnitMinutes => 'dakika önce';

  @override
  String get reminderUnitHours => 'saat önce';

  @override
  String get reminderUnitDays => 'gün önce';

  @override
  String get remindersPermissionDenied =>
      'Bu uygulama için bildirimlere izin verilmiyor. Hatırlatıcıları kullanmak için sistem ayarlarından etkinleştirin.';

  @override
  String get remindersChannelName => 'Görev hatırlatıcıları';

  @override
  String get remindersChannelDescription =>
      'Cemaat görevlerinizden önce bildirimler';
  ...
  @override
  String get statTotalMembers => 'Tüm müjdeciler';
