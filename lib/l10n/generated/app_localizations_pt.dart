...
class AppLocalizationsPt extends AppLocalizations {
  ...
  @override
  String get reportParticipatedShort => 'Participou';

  @override
  String get reportStudiesShort => 'Estudos';
  ...
  String get s21BatchConfirmTitle =>
      'Exportar a S-21 de todos os publicadores?';

  @override
  String s21BatchConfirmBody(int count, String years) {
    return 'Será gerado um único PDF com $count cartões de publicador, cada um referente a $years. O ficheiro contém dados pessoais — datas de nascimento e batismo, designação e todo o histórico de relatórios. Guarde-o em segurança e partilhe-o apenas com quem precisa. Numa congregação grande isto pode demorar algum tempo.';
  }

  @override
  String get s21BatchGenerating => 'A gerar cartões S-21…';
  ...
  @override
  String get pubPdfTitle => 'Perfis dos publicadores';

  @override
  String pubPdfGenerated(String date, int count) {
    return 'Gerado em $date · $count publicadores';
  }
  ...
  @override
  String get pubPdfConfirmTitle => 'Exportar os perfis dos publicadores?';

  @override
  String pubPdfConfirmBody(int count) {
    return 'O PDF conterá dados pessoais de $count publicadores — endereços, números de telefone, datas de nascimento e batismo e notas de emergência. Guarde o arquivo com segurança e compartilhe-o apenas com quem precisa dele.';
  }

  @override
  String get pubExportScopeTitle => 'Verifique o que será exportado';

  @override
  String pubExportScopeListed(int count) {
    return 'A exportação abrange os $count registros atualmente listados.';
  }

  @override
  String pubExportScopeMissing(int missing, int total) {
    return '$missing dos $total publicadores da congregação estão fora do filtro.';
  }

  @override
  String pubExportScopeExtra(int count) {
    return '$count registros listados não são publicadores ativos — situação de serviço «-» ou mudados.';
  }

  @override
  String get pubExportScopeHint =>
      'Ative o filtro «Publicadores» e limpe os demais para abranger todos.';
  ...
  String get pubAdminMovedNoDateHint =>
      'Não há data de mudança registrada, por isso nenhum relatório dele conta nas estatísticas nem no S-1. Informe a data para recuperar os meses em que ele ainda estava aqui.';
  ...
  String get fsmDeleteFromWeekTooltip =>
      'Excluir as reuniões a partir desta semana';

  @override
  String fsmDeleteFromWeekTitle(String week) {
    return 'Excluir as reuniões a partir de $week?';
  }

  @override
  String get fsmDeleteFromWeekBody =>
      'Isto exclui todas as reuniões avulsas e recorrentes a partir da semana selecionada e encerra aí as reuniões recorrentes, para que não voltem a aparecer. As reuniões anteriores são mantidas. Não é possível desfazer.';

  @override
  String get fsmDeleteFromWeekDone => 'Reuniões excluídas.';
  ...
  @override
  String get meetingWeekDay => 'Dia';

  @override
  String get meetingWeekTime => 'Horário';

  @override
  String get coVisitNotPublished =>
      'A visita do superintendente de circuito ainda não foi publicada.';

  @override
  String get coVisitNonePlanned => 'Nenhuma visita programada ainda.';

  @override
  String get coVisitSetWeek => 'Escolha a semana da visita';

  @override
  String get coVisitDelete => 'Excluir a visita';

  @override
  String get coVisitDeleteConfirm =>
      'Excluir esta visita e tudo o que foi organizado para ela? As reuniões para o serviço de campo dessa semana são mantidas. Isso não pode ser desfeito.';

  @override
  String get coVisitVisibleToPublishers => 'Mostrar aos publicadores';

  @override
  String get coVisitVisibleOn => 'Os publicadores veem a visita.';

  @override
  String get coVisitVisibleOff => 'Somente os administradores veem a visita.';

  @override
  String get coSectionMeal => 'Almoços';

  @override
  String get coSectionShepherding => 'Visitas de pastoreio';

  @override
  String get coSectionPioneers => 'Reunião com os pioneiros';

  @override
  String get coSectionElders => 'Reunião com os anciãos e servos ministeriais';

  @override
  String get coSectionOther => 'Outros';

  @override
  String get coSectionEmpty => 'Nada organizado ainda.';

  @override
  String get coSectionHidden => 'Oculto';

  @override
  String get coSectionHide => 'Ocultar dos publicadores';

  @override
  String get coSectionShow => 'Mostrar aos publicadores';

  @override
  String get coWithCo => 'Serviço de campo com o superintendente de circuito';

  @override
  String get coWithCoWife => 'Serviço de campo com a esposa dele';

  @override
  String get coDay => 'Dia';

  @override
  String get coTime => 'Horário';

  @override
  String get coAddress => 'Endereço';

  @override
  String get coNote => 'Observação';
  ...
  String get coMinistryOtherAdmins =>
      'As reuniões para o serviço de campo são editadas pelos administradores delas.';

  @override
  String get coMidweekOtherAdmins =>
      'O dia da reunião do meio de semana é definido pelos administradores desse programa.';

  @override
  String get coMidweekNotMoved =>
      'A reunião do meio de semana não foi movida para terça-feira: isso é definido pelos administradores desse programa.';

  @override
  String get coPrintTitle => 'Imprimir o programa da visita';

  @override
  String get coPrintIncludeHiddenBody =>
      'Algumas seções estão ocultas dos publicadores. Imprimir também?';

  @override
  String get coPrintIncludeHidden => 'Incluir ocultas';

  @override
  String get coPrintVisibleOnly => 'Somente visíveis';
  ...
  @override
  String get reportEmpty => 'Relatório vazio — sem serviço';

  @override
  String get reportNotCountedMoved => 'Mudou-se — não contabilizado';
