...
@JsonKey(includeFromJson: false, includeToJson: false) String get id; String get talkTitle;/// This week only: the meeting is held on another day / at another time
...
@JsonKey(includeIfNull: false) int? get meetingWeekday;@JsonKey(includeIfNull: false) String? get meetingTime;/// S-99 talk number when the title was picked from the catalog;
